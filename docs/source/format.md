...
* `cap_zero` (0 or 1): Flag indicating if zero-capacity exclusions are used.
...
* **Default:** `a <from> <to> <low> <cap_total> <cap_total> <cost>`
* **Commodity-specific capacities:** `a <from> <to> <low> <cap_total> <cap_1> ... <cap_K> <cost>`
* **Commodity-specific costs:** `a <from> <to> <low> <cap_total> <cap_total> <cost_1> ... <cost_K>`
* **Fully Randomized:** `a <from> <to> <low> <cap_total> <cap_1> ... <cap_K> <cost_1> ... <cost_K>`
